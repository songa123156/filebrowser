...
type AuthCommon struct {
	...
	UnauthorizedRedirectUrl string   `json:"unauthorizedRedirectUrl"` // redirect URL used when an external-auth user is authenticated but not allowed by userGroups.
